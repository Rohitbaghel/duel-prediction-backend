          ...
          <ol className="text-left mb-6 list-decimal list-inside space-y-3 text-[#a1a1a1]">
            <li>
              ...
              <a
                ...
                className="text-[#00d26a] underline hover:text-[#00b85c]"
              >
                Privy Dashboard
              </a>{" "}
              and create an app
            ...
            <li>
              Create a{" "}
              <code className="bg-[#141414] px-2 py-0.5 rounded text-white">
                .env
              </code>{" "}
            ...
            <li>
              Add:{" "}
              <code className="bg-[#141414] px-2 py-0.5 rounded text-[#00d26a]">
